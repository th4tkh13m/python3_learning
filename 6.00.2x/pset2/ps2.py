...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        next_tile = self.pos.getNewPosition(self.getRobotDirection(), self.speed)
        if self.room.isPositionInRoom(next_tile):
...
#Visualizing the Bot
#Note: Uncomment the 3 animating code lines in the runSimulation function for visualizing the bot cleaning the room! 
# Otherwise, it will return the mean value of the time-steps.
