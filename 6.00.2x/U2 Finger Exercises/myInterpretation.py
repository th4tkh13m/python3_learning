...
def drunkTest(walkLengths, numTrials, dClass, toPrint = False):
...
def simAll(drunkKinds, walkLengths, numTrials):
    for dClass in drunkKinds:
        drunkTest(walkLengths, numTrials, dClass, toPrint = True)
...
def plotTrend(dClass, walkLengths, numTrials):
    ...
    pylab.plot(walkLengths, mean_dis, label = 'Usual Drunk')
...
if __name__ == '__main__':
    #simAll((UsualDrunk, MasochisticDrunk), (10, 100, 1000, 10000), 100)
